...
<form class="wcpv-shortcode-registration-form">
	...
	<p class="form-row form-row-wide">
		<label for="wcpv-vendor-description-public">
			<input class="form-check-input" type="checkbox" name="vendor_description_public" id="wcpv-vendor-description-public" value="1" tabindex="8" />
    ...
    <!-- TODO WCY -->
	<p class="form-row">
		<input type="submit" class="btn btn-primary" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce-product-vendors' ); ?>" tabindex="8" />
	</p>
