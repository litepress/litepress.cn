...
<label class="jck-sfr-form__row" for="jck-sfr-input-email">
	...
	<input id="jck-sfr-input-email" name="jck-sfr-login-email" class="jck-sfr-form__field jck-sfr-form__field--input" type="text" value="<?php echo esc_attr( $email ); ?>">
</label>

<label class="jck-sfr-form__row" for="jck-sfr-input-password">
	<strong><?php _e( 'Password', 'simple-feature-requests' ); ?></strong>
	<input id="jck-sfr-input-password" name="jck-sfr-login-password" class="jck-sfr-form__field jck-sfr-form__field--input" type="password">
</label>
...
<label class="jck-sfr-form__row jck-sfr-js-toggle-register-login" for="jck-sfr-input-repeat-password" style="display: none;">
	...
	<input id="jck-sfr-input-repeat-password" name="jck-sfr-login-repeat-password" class="jck-sfr-form__field jck-sfr-form__field--input" type="password">
</label>
