...
<label class="jck-sfr-form__row jck-sfr-js-toggle-register-login" style="display: none;">
	<strong><?php _e( 'Username', 'simple-feature-requests' ); ?></strong>
	<input name="jck-sfr-login-username" class="jck-sfr-form__field jck-sfr-form__field--input" type="text" value="<?php echo esc_attr( $username ); ?>">
</label>

<label class="jck-sfr-form__row">
	...
	<input name="jck-sfr-login-email" class="jck-sfr-form__field jck-sfr-form__field--input" type="text" value="<?php echo esc_attr( $email ); ?>">
</label>

<label class="jck-sfr-form__row">
	<strong><?php _e( 'Password', 'simple-feature-requests' ); ?></strong>
	<input name="jck-sfr-login-password" class="jck-sfr-form__field jck-sfr-form__field--input" type="password">
</label>

<label class="jck-sfr-form__row jck-sfr-js-toggle-register-login" style="display: none;">
	<strong><?php _e( 'Repeat Password', 'simple-feature-requests' ); ?></strong>
	<input name="jck-sfr-login-repeat-password" class="jck-sfr-form__field jck-sfr-form__field--input" type="password">
</label>
