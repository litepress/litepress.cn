...
namespace LitePress\WCAPI\Inc\Api\User;

use LitePress\WCAPI\Inc\Api\Base;
use LitePress\WCAPI\Inc\Service\User_Service;
use WP_REST_Request;
 ...
 * 该接口用于返回当前用户的相关信息
 *
 * @package LitePress\WCAPI\Inc\Api\User_Info
 */
class User_Info extends Base {

	public function __construct() {
		register_rest_route( 'store/v1', 'user_info', array(
			'methods'  => WP_REST_Server::CREATABLE,
			'callback' => array( $this, 'user_info' ),
		) );
	}

	public function user_info( WP_REST_Request $request ): WP_REST_Response {
		// 首先对输入数据消毒
