 ...
 * 该接口用于检查某个订单的支付状态
 *
 * @package LitePress\WCAPI\Inc\Api\Order_Check
 */
class Order_Check extends Base {

	public function __construct() {
		register_rest_route( 'store/v1', 'order_check', array(
			'methods'  => WP_REST_Server::CREATABLE,
			'callback' => array( $this, 'order_check' ),
		) );
	}

	public function order_check( WP_REST_Request $request ): WP_REST_Response {
