...
namespace LitePress\WCAPI\Inc\Api\Product;

use LitePress\WCAPI\Inc\Api\Base;
use LitePress\WCAPI\Inc\Service\Product_Service;
use WP_REST_Request;
 ...
 * 该接口用于返回单个商品的有关信息
 *
 * @package LitePress\WCAPI\Inc\Api\Product_Single
 */
class Product_Single extends Base {

	public function __construct() {
		register_rest_route( 'store/v1', 'product_single', array(
			'methods'  => WP_REST_Server::CREATABLE,
			'callback' => array( $this, 'product_single' ),
		) );
	}

	public function product_single( WP_REST_Request $request ): WP_REST_Response {
