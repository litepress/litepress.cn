            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
                        ...
                        <h1 class="g-brand g-has-medium-font-size">与 Gravatar API 兼容</h1>
            ...
            <div class="container">
                <div class="row justify-content-center justify-content-md-between">
                    <div class="d-flex flex-column col-12 col-md-6 col-lg-5 text-center text-md-left justify-content-center order-md-2">
                        ...
                        <p class="text-h-gray paragraph">正如 Gravatar 在国外做的那样，Cravatar 希望在中国建立一个开放的头像标准，你可以访问我的 <a
                                    href="/developers">开发者资源</a>，快速的在你的网站/应用中接入 Cravatar。</p></div>
