...
<form class="jck-sfr-form jck-sfr-form--submission" action="" method="post" autocomplete="off">
	...
	<label for="jck-sfr-input-title" class="jck-sfr-form__row">
		...
		<div class="jck-sfr-search-field">
			<input id="jck-sfr-input-title" name="jck-sfr-submission-title" class="form-control jck-sfr-form__field jck-sfr-form__field--input jck-sfr-form__title" type="text" placeholder="<?php esc_attr_e( 'Enter your request...', 'simple-feature-requests' ); ?>" value="<?php echo esc_attr( $title ); ?>" autocomplete="jck-sfr-ac-off">
