...
<!--表单标题--><div class="post-form-main fl-col col-xl-9">
					<p>
						<label for="bbp_topic_title"><?php printf( esc_html__( 'Topic Title (Maximum Length: %d):', 'bbpress' ), bbp_get_title_max_length() ); ?></label><br />
						<input type="text" id="bbp_topic_title" value="<?php bbp_form_topic_title(); ?>" placeholder="在此输入标题……" size="40" name="bbp_topic_title" maxlength="<?php bbp_title_max_length(); ?>" />
					</p>
...
<div class="fl-col post-form-sidebar col-xl-3">
						<p class="pf-side-item">
							<label for="bbp_topic_tags" class="pf-side-label"><?php esc_html_e( 'Topic Tags:', 'bbpress' ); ?></label><br />
							<input class="pf-side-input"  type="text" value="<?php bbp_form_topic_tags(); ?>" size="40" name="bbp_topic_tags" id="bbp_topic_tags" <?php disabled( bbp_is_topic_spam() ); ?> />
						</p>
...
<!--表单分类-->
						<p class="pf-side-item">
							<label for="bbp_forum_id" class="pf-side-label"><?php esc_html_e( 'Forum:', 'bbpress' ); ?></label><br />
							<?php
								bbp_dropdown( array(
					...
					<?php if ( current_user_can( 'moderate', bbp_get_topic_id() ) ) : ?>
						...
						<p class="pf-side-item">
							...
							<label class="pf-side-label" for="bbp_stick_topic"><?php esc_html_e( 'Topic Type:', 'bbpress' ); ?></label><br />
						...
						<p class="pf-side-item">
							...
							<label class="pf-side-label" for="bbp_topic_status"><?php esc_html_e( 'Topic Status:', 'bbpress' ); ?></label><br />
    ...
    <p class="bbp-attachments-form">
        ...
        <button type="button" class="ant-btn btn btn-outline-primary" ><i class="fas fa-cloud-upload"></i><span>点击上传</span><input class="bbp-upload-input" type="file" size="40" multiple="multiple" name="d4p_attachment[]" style="    opacity: 0;
    position: absolute;
    left: 0;
    top: 0;
 ...
 <div class="showFileName">
               <ul></ul>
					...
					<div class="bbp-submit-wrapper">
                        ...
                        <button type="submit" id="bbp_reply_submit" name="bbp_reply_submit" class="button submit btn btn-primary"><i class="fad fa-paper-plane"></i><?php esc_html_e( 'Submit', 'bbpress' ); ?></button>
