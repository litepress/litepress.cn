	...
	<td colspan="5">
		<div class="strings editor-panel__left">
			...
			<p>
				...
				<button  class="action save btn btn-primary" data-nonce="<?php echo esc_attr( wp_create_nonce( 'edit-glossary-entry_' . $entry->id ) ); ?>"><?php _e( 'Save', 'glotpress' ); ?></button><span class="or-cancel"><?php _e( 'or', 'glotpress' ); ?> <a href="#" class="action cancel btn btn-outline-primary"><?php _e( 'Cancel', 'glotpress' ); ?></a></span>
			</p>
		</div>
