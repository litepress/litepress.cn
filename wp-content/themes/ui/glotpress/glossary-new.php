<?php
gp_title( __( 'Create New Glossary - LitePress翻译平台', 'glotpress' ) );
gp_breadcrumb(
	array(
...
<form action="" method="post">
	<p>
		...
		<textarea class="form-control" id="glossary-new-description" name="glossary[description]" rows="4" cols="40"></textarea>
	</p>
	<p>
		...
		<span class="or-cancel"><?php _e( 'or', 'glotpress' ); ?> <a class="btn btn-outline-primary" href="<?php echo esc_url( gp_url_project_locale( $project, $locale->slug, $translation_set->slug ) ); ?>"><?php _e( 'Cancel', 'glotpress' ); ?></a></span>
	</p>
