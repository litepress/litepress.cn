			...
			<?php if ( is_user_logged_in() ): ?>
                <form style="max-width: 640px" class="trusteeship_form needs-validation">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="type" id="plugin" value="plugin" checked required>
                        <label class="form-check-label" for="plugin">插件</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="type" id="theme" value="theme" required>
