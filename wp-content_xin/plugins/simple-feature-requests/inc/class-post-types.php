...
class JCK_SFR_Post_Types
{
    ...
    public static function admin_bar_menu_item()
    {
        global  $wp_admin_bar ;
        $menu_id = 'jck-sfr';
        $default_plural_name = apply_filters( 'jck_sfr_plural_request_name', 'Requests', true );
        $wp_admin_bar->add_menu( array(
            'id'    => $menu_id,
            'title' => sprintf( __( '%s', 'simple-feature-requests' ), $default_plural_name ),
            'href'  => '',
        ) );
        $default_single_name = apply_filters( 'jck_sfr_single_request_name', 'Feature Request', true );
        if ( self::is_type( 'single' ) ) {
            $wp_admin_bar->add_menu( array(
                'parent' => $menu_id,
        ...
        $default_child_plural_name = apply_filters( 'jck_sfr_child_plural_request_name', 'Feature Requests', true );
        $wp_admin_bar->add_menu( array(
            'parent' => $menu_id,
