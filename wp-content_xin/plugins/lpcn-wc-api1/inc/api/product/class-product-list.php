 ...
 * 该接口用于列出指定查询参数下的商品列表
 *
 * @package LitePress\WCAPI\Inc\Api\Product_List
 */
class Product_List extends Base {

	public function __construct() {
		register_rest_route( 'store/v1', 'product_list', array(
			'methods'  => WP_REST_Server::CREATABLE,
			'callback' => array( $this, 'product_list' ),
		) );
	}

	public function product_list( WP_REST_Request $request ): WP_REST_Response {
