            ...
            <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center min-vh-lg-100 position-relative bg-light px-0">
                ...
                <div style="max-width: 23rem;">
                    <div class="text-center mb-5">
                        <img class="img-fluid"
                             src="https://htmlstream.com/preview/front-dashboard-v2.0/assets/svg/illustrations/oc-chatting.svg"
                    ...
                    <span class="d-flex justify-content-center align-items-center">
                      ...
                      微信登录
                        ...
                        <section class="form-sign ">
                            ...
                            <div class="px-4">
                                <ul class="nav lp-nav-tabs nav-tabs mb-4 border-0 justify-content-center" id="sign-tab" role="tablist">
